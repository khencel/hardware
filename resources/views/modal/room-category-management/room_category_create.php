<!-- Modal -->
<div class="modal fade" id="room_category_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    <div class="row">
      <div class="col">
        ...
        <input type="text" class="form-control" id="room_category_name">
        <div>
    ...
    <div class="row mt-2">
      <div class="col">
        ...
        <select name="" class="form-control" id="room_category_type">
      ...
      <div class="col">
        ...
        <select name="" class="form-control" id="room_category_near_at">
          <option value="" disabled selected>-- Select --</option>
    ...
    <div class="row mt-2">
      <div class="col">
        ...
        <textarea name="" class="form-control" id="room_category_description"></textarea>
      </div>
    </div>
    ...
    <div class="row mt-2">
      <div class="col">
        ...
        <input type="checkbox" id="room_category_is_available">
        <div>
  ...
  <button type="button" class="btn button-success" onclick="store_room_category()">Create</button>
  </div>
  </div>
  </div>
</div>